...
{ // Agent
if (strcmp(username, "agent") == 0 && strcmp(password, "123") == 0) 
{
setColor(GREEN);
...
strcpy(courseTitles[j], courseTitles[j + 1]);
strcpy(courseInstructors[j], courseInstructors[j + 1]);
...
for (int i = 0; i < courseCount; i++) 
{
if (strstr(courseTitles[i], keyword)) 
{
